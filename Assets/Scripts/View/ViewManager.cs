...
public class ViewManager : MonoBehaviour
{
    ...
    [SerializeField] protected WeaponsView weaponsViewPrefab = null;
    ...
    public WeaponsView WeaponsView { private set; get; }
    ...
    private void Awake()
    {
        ...
        else 
        {
            ...
            if (transform.childCount == 0)
            {
                ...
                WeaponsView = Instantiate(weaponsViewPrefab, transform, false);
                WeaponsView.transform.localScale = Vector3.one;
                WeaponsView.OnHide();
            }
        }
    }
    ...
    public void SetActiveView(ViewType viewType)
    {
        ...
        switch(viewType)
        {
            ...
            case ViewType.EndgameView:
                ...
                break;
            case ViewType.WeaponsView:
                WeaponsView.gameObject.SetActive(true);
                WeaponsView.OnShow();
